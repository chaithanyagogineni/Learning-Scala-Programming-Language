...
def getProduct(value:Int,row:Int,col:Int,a:Array[Array[Int]]):BigInt ={
var up:BigInt=1
var down:BigInt=1
var left:BigInt=1
var right:BigInt =1
...
for(i<- 1 to 4)
{
downdiagonal*=a(dstart)(dend)
dstart+=1
dend+=1
}
}
//compute the updiagonal product
if(row>=3&&col<=16)
{
var s=row
var e=col
...
for(j<- 0 until 20)
{
var k:BigInt = getProduct(a(i)(j),i,j,a)
if(temp<k)
temp=k
}
}
